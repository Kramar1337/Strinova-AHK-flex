...
GetKID:
{
IniWrite, 0x%outVarKe1%, %A_ScriptDir%\config.ini, Settings, KeyboardVID
IniWrite, 0x%outVarKe2%, %A_ScriptDir%\config.ini, Settings, KeyboardPID
}
Return
...
GetMID:
{
IniWrite, 0x%outVarMi1%, %A_ScriptDir%\config.ini, Settings, MouseVID
IniWrite, 0x%outVarMi2%, %A_ScriptDir%\config.ini, Settings, MousePID
}
Return
